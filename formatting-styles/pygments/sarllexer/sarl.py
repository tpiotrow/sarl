...
class SarlLexer(RegexLexer):
	...
	tokens = {
		'root': [
			...
			(r'(as|assert|assume|break|case|catch|continue|default|do|else|extends|extension|finally|fires|for|if|implements|instanceof|invariant|new|on|requires|return|super|switch|throw|throws|try|typeof|uses|while|with)\b',
			 Keyword),
