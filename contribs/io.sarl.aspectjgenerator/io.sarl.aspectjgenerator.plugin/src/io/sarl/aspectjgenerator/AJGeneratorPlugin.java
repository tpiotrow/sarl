...
package io.sarl.aspectjgenerator;
 ...
 */
public class AJGeneratorPlugin extends AbstractUIPlugin {
	 ...
	 */
	public static void setDefault(AJGeneratorPlugin defaultInstance) {
	 ...
	 */
	public static AJGeneratorPlugin getDefault() {
		return instance;
	}

	/**
	 * Returns a section in the SARL Eclipse plugin's dialog settings.
	 * If the section doesn't exists yet, it is created.
